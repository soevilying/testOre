...
translate Thai Temple_map_1c8445e3:


    "Then it hits you."


translate Thai Temple_map_da153041:


    "Memories of the past days, the note, Meko’s possession, the warning about a spirit among your friends."


translate Thai Temple_map_2bb7e6aa:
...
translate Thai Temple_book_396db4ea:


    "{u}{i}Transcending the barriers that divide the rest of our world.{/i}{/u}"


translate Thai Temple_book_8da42f96:


    "{u}{i}With our magic we will show them all the way.{/i}{/u}"


translate Thai Temple_book_8125b963_1:


    "You close the book and leave."


translate Thai Temple_book_57e0141d:


    "Wait, what's this?"


translate Thai Temple_book_e120c181:


    "You find a Mysterious Note."


translate Thai Temple_book_963858d3:


    "The top half where the date would be has been torn off."


translate Thai Temple_book_9bbadb2b:


    "It looks like a segment of a story."


translate Thai Temple_book_188bb26c:


    "{u}{i}In the beginning there was only One.{/i}{/u}"


translate Thai Temple_book_a8664560:
...
translate Thai Temple_book_e2de7689:
...
translate Thai Temple_book_be076a29:
