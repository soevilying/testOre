...
translate Thai Nauxus_event_1_4efb287d:
...
translate Thai Nauxus_artwork_0c663882:


    n "Mmm, whatever you’re making, do more."


translate Thai Nauxus_artwork_804bb008:
...
translate Thai Nauxus_darkswamp_ab4264d0:
...
translate Thai Nauxus_darkswamp_13ebd9b3:


    e 5 "It’s an ambush! Get to cover!"


translate Thai Nauxus_darkswamp_861d7975:
...
translate Thai Nauxus_darkswamp_09cce4f9:


    "Nauxus crosses his arms and his pupils sharpen."


translate Thai Nauxus_darkswamp_4173df33:
...
translate Thai Nauxus_darkswamp_7edd3318:
...
translate Thai strings:
    ...
    new "Finding a way out of the fog"


    old "Exploring the lands"
    new "Exploring the lands"
    ...
    new "I’d consider it a victory"


    old "Invite Nauxus on a date"
    new "Invite Nauxus on a date"
    ...
    new "Discuss about Selye"


    old "Ask about Nauxus’s council members"
    new "Ask about Nauxus’s council members"


    old "Ask about the proof of the kidnappings."
    new "Ask about the proof of the kidnappings."


    old "Ask about Nauxus’s plans after the war"
    new "Ask about Nauxus’s plans after the war"


    old "A lizard on fire while someone is lying on the ground to not get burnt."
    new "A lizard on fire while someone is lying on the ground to not get burnt."


    old "Nauxus training lizards to do push ups."
    new "Nauxus training lizards to do push ups."


    old "A lizard with red hair watching another lizard doing push ups."
    new "A lizard with red hair watching another lizard doing push ups."


    old "Nauxus hiding behind a tree while a bull looks at a pile of rocks.."
    new "Nauxus hiding behind a tree while a bull looks at a pile of rocks.."


    old "Nauxus meeting a bull in secret while the bull looks at a burnt up campfire."
    new "Nauxus meeting a bull in secret while the bull looks at a burnt up campfire."


    old "Nauxus spying on a bull from behind a tree who found a pile of coins."
    new "Nauxus spying on a bull from behind a tree who found a pile of coins."


    old "Red and Blue kissing and Nauxus is watching them in the bushes"
    new "Red and Blue kissing and Nauxus is watching them in the bushes"


    old "A sick and angry lizard butting heads on a carpet."
    new "A sick and angry lizard butting heads on a carpet."


    old "A lizard wearing a red hat and a lizard wearing a blue hat holding hands and talking to each other."
    new "A lizard wearing a red hat and a lizard wearing a blue hat holding hands and talking to each other."


    old "Three lizards standing around"
    new "Three lizards standing around"


    old "The lizard trio relaxing"
    new "The lizard trio relaxing"


    old "The lizard trio practising their signature poses"
    new "The lizard trio practising their signature poses"


    old "Nauxus and I walking along the village"
    new "Nauxus and I walking along the village"


    old "The tour we took"
    new "The tour we took"


    old "I leading Nauxus towards battle"
    new "I leading Nauxus towards battle"


    old "Encourage Nauxus to touch you lower"
    new "Encourage Nauxus to touch you lower"


    old "Tell Nauxus to focus on the plan"
    new "Tell Nauxus to focus on the plan"
