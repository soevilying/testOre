...
label bull_lick_gcg:
    ...
    call screen gallery
    return
label gargoyle_lose_gcg:
    $ renpy.music.set_pause(True, channel='music')
    scene caveruin 1n with vslow_dissolve
...
label Hakan_sixnine_gcg:
    $ renpy.music.set_pause(True, channel='music')
    scene hakan_sauna01 with vslow_dissolve
